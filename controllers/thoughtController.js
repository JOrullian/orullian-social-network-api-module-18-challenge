...
module.exports = {
  ...
  // Create thought and add it to user by userId
  async createThought(req, res) {
    try {
      const thought = await Thought.create(req.body);

      // Find the user by userId from req.body (or req.params, depending on where you send it)
      const user = await User.findOneAndUpdate(
        { _id: req.body.userId }, // Use userId from req.body
